...
const Footer = () => {
  return <footer className=' border-t py-12 px-5'>
    <div className=' container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <p className="font-medium text-gray-600">Sign up and get 10% off your first order</p>
            {/* News Letter form */}
            <form className=' flex'>
                <input type="email" placeholder='Enter Your Email' className="p-3 w-full text-sm
             border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-600 transition-all "
             required></input>
        ...
        {/* Shop links */}
        <div>
            <h3 className='text-lg text-gray-400 mb-4'>Shop</h3>
        ...
        <div>
            <h3 className='text-lg text-gray-400 mb-4'>Support</h3>
            <ul className=' space-y-2 text-gray-600'>
                <li>
    ...
    {/* Footer copy right */}
    <div className=' container mx-auto mt-12 px-2 lg:px-0 border-t border-gray-200 pt-6 '>
        <p className='text-gray-500 text-sm tracking-tighter text-center'> 
         © 2025, CompileTab. All Right Reserverd
        </p>
    </div>
  </footer>
}
