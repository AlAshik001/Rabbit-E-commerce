...
const navigate = useNavigate()
  ...
  const handlePricehange = (e) => {
    const newPrice = e.target.value;
    setPriceRange([0, newPrice])
    const newFilters = {...filters, mniPrice:0, maxPrice: newPrice}
    setFilters(filters)
    updateURLParams(newFilters)
  }
  ...
  return (
    <div className='p-4'>
    <h1 className='text-xl font-medium text-gray-800 mb-4'>Filter</h1>
