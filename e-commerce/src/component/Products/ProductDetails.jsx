...
const ProductDetails = ({productId}) => {
    ...
    const handleAddtoCart = () =>{
        if(!selectedSize || !selectedColor){
            toast.error("Plase select a size and color before adding to cart",{
                duration:1000,
            });
            return;
        }
            ...
            <div className='hidden md:flex flex-col space-y-4 mr-6'>
                {selectedProduct.images.map((image, index) =>
                {
                 return   <img 
                    key={index}
                    src={image?.url} 
                    alt={image.altText || `Thaumnail ${index}`}
            ...
            <div className='mb-4'>
                ...
                <div className=' flex gap-2 mt-2'>
                    {selectedProduct.colors.map((color) =>(
                        ...
                        className={`w-8 h-8 rounded-full border ${selectedColor === color ? "border-4 border-black"
                            : "border-gray-300"
                        }`}
            ...
            <div className="mb-4">
                ...
                <div className="flex gap-2 mt-2">
                    {selectedProduct.sizes.map((size)=>(
                        ...
                        className={`px-4 py-2 rounded border ${selectedSize === 
